...
description: "Analog layout synthesis system that takes SPICE netlists and constraints through hierarchy recognition, primitive generation, placement and routing to GDSII layouts."
keywords: ["Analog layout", "Placement", "Routing", "Constraints"]
workflow:
  generate-edit: core
  physical: core
...
Recognizes circuit hierarchy, generates primitive layout cells and assembles constrained placement/routing. Generate / Edit and Physical are core for generated layout artifacts; this is not unrestricted circuit-topology synthesis. [Flow](#source-readme) and [entry point](#source-implementation).
