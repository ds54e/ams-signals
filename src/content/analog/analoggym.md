...
The benchmark/environment exposes circuit sizing and ngspice evaluation. Optional learning baselines do not turn the environment or its numerical simulator into a model-driven stage. [AI/stage evidence](#source-review).
