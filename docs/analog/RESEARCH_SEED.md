...
Use these questions to ground catalog prose. The current Scope contract is defined in `IMPLEMENTATION_SPEC.md`; these historical research questions do not define additional classification fields or scores.
